...
### 🚀 Sobre Mim
* 🎓 Bacharel em **Sistemas de Informação** (Centro Universitário UNA).
* 💻 **Desenvolvedor Full Stack** focado no ecossistema TypeScript (**Node.js, NestJS, React.js e Next.js**)[cite: 1].
* ☁️ **Cloud & DevOps:** Certificado **AWS Certified Cloud Practitioner**, com experiência prática no design de arquiteturas Serverless utilizando **AWS CDK, Lambda, S3 e DynamoDB**.
* 🛡️ Práticas de **Clean Code**, arquitetura de software, segurança (Autenticação JWT/RBAC), validações com **Zod** e testes automatizados (**Jest / TDD**).
* 📍 Disponível para oportunidades como **Desenvolvedor Júnior / Trainee** (Remoto, Híbrido ou Presencial).
...
* **Bancos de Dados & ORMs:**
  ...
  ![TypeORM](https://img.shields.io/badge/TypeORM-FE0101?style=for-the-badge&logo=typeorm&logoColor=white)

#### 🔹 Outras Competências & Bagagem Acadêmica
...
* 📧 **E-mail:** [alexandre_augusto_garcia@hotmail.com](mailto:alexandre_augusto_garcia@hotmail.com)
